...
from keras.layers import Add,Subtract,Dot
...
def get_model():
    ...
    bigru_att = AttentivePoolingLayer()(bigru)
    sentEncoder = Model(sentence_inp, bigru_att)
    ...
    bigru_sent_att = AttentivePoolingLayer()(bigru_sent)


    fc1 = Dense(256, activation='relu')(bigru_sent_att)
