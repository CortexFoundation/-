...
from keras.layers import Dense, Activation, Dropout, Embedding,BatchNormalization,Bidirectional,Conv1D,GlobalMaxPooling1D
...
test_pred[["id","class"]].to_csv('../sub/sub_lstm_baseline.csv',index=None)
t2=time.time()
